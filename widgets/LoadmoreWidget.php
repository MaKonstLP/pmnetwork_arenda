...
namespace frontend\modules\arenda\widgets;
...
class LoadmoreWidget extends Widget
{
	...
	public function run()
	{
		// $buttons = '<div class="items_pagination1">';
		$buttons = '';
		if ($this->total > 1) {
	...
	private function renderPageButton($page, $amount, $test)
	{
		...
		return '<div class="button_loadmore" data-page-id="' . $page . '" data-listing-pagitem>Показать ещё</div>';
	}
